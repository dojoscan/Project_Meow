...
def deep_meow_net(x):
    ...
    # conv1 1x5
    W_conv1 = weight_variable([5, 1, 3, 64])
    ...
    # conv3 1x5
    W_conv3 = weight_variable([5, 1, 64, 64])
    b_conv3 = bias_variable([64])
    h_conv3 = tf.nn.relu(conv2d(h_pool1, W_conv3) + b_conv3)
    ...
    # conv5 1x5
    W_conv5 = weight_variable([5, 1, 64, 64])
    b_conv5 = bias_variable([64])
    h_conv5 = tf.nn.relu(conv2d(h_pool2, W_conv5) + b_conv5)

    # conv6 5x1
    W_conv6 = weight_variable([1, 5, 64, 64])
    ...
    # conv7 3x3
    W_conv7 = weight_variable([3, 3, 64, 10])
