...
def fire(x, input_depth, s1x1, e1x1, e3x3, name):
    with tf.variable_scope(name):
        ...
        with tf.variable_scope('Expand'):
            ...
            W_e3x3 = weight_variable([3, 3, e3x3, e3x3], 0.1, 'Weights3x3')
...
def asym_squeeze_net(x, keep_prop):
    ...
    with tf.variable_scope('Conv1'):
        W_conv1 = weight_variable([3, 3, 3, 32], 0.1, 'Weights')
    ...
    with tf.variable_scope('Conv2'):
        W_conv3 = weight_variable([3, 3, 768, (NR_CLASSES+1+4)*NR_ANCHORS_PER_CELL], 0.1, 'Weights')
