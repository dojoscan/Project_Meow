guauNET: a convolutional neural network-based object detector that processing single images and output bounding box predictions. Requires TensorFlow 1.0 and Python 3.5.
